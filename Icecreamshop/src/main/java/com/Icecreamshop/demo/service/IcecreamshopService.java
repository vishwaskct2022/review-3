...
public class IcecreamshopService {
	...
	{
		return IcecreamshopService.updateIcecreamshopByName(name,colour);
	}
	
	@Transactional
	public int deleteIcecreamshopByName(String name)
	{
		return IcecreamshopService.deleteIcecreamshopByIteamname(name);
	}
